package com.mrtian.project.ui.widget.waveview;
...
/**
 * Created by tianxiying on 2017/4/26.
 */
...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#10FFFFFF");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#08FFFFFF");
    ...
    private void createShader() {
        ...
        for (int beginX = 0; beginX < endX; beginX++) {
            ...
            float beginY = (float) (mDefaultWaterLevel + 5 * mDefaultAmplitude * Math.sin(wx));
        ...
        for (int beginX = 0; beginX < endX; beginX++) {
            canvas.drawLine(beginX, waveY[(beginX + wave2Shift) % endX] - 30, beginX, endY, wavePaint);
        }
